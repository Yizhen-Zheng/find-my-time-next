export type Task = {
  ...
  taskType?: "Meeting" | "Work" | "Personal" | "Learning" | "Health" | "Other";
  duration?: number; // Priority level.
  // Priority level.
  importance: "High" | "Medium" | "Low";
  // The date the AI determines the task should be done by.
  dueDate: string; // Format in supabase timestamptz: YYYY-MM-DD hh:mm:ss.xxxxxx+00
  // currently not needed(test phase)
  userId?: string;
  // detect created date, will be used to 'expired' a task
  createdAt?: Date; // Format in supabase timestamptz: YYYY-MM-DD hh:mm:ss.xxxxxx+00
};
